...
if [ $KSU_ENABLE -eq 1 ]; then
    echo "KSU is enabled"
    curl -LSs "https://raw.githubusercontent.com/rifsxd/KernelSU-Next/refs/heads/next/kernel/setup.sh" | bash -s v1.0.2-R14
...
ZIP_FILENAME=Kernel_MIUI_${TARGET_DEVICE}_anykernel3.zip
